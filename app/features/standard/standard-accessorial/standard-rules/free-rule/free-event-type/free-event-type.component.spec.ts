...
import { FreeEventTypeStandardComponent  } from './free-event-type.component';
...
describe('FreeEventTypeStandardComponent ', () => {
  let component: FreeEventTypeStandardComponent ;
  let fixture: ComponentFixture<FreeEventTypeStandardComponent >;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(FreeEventTypeStandardComponent );
  ...
  it('should call onSelectEventName', () => {
    component.onSelectEventName(event);
  });
