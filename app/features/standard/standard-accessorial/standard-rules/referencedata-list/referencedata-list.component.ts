...
export class ReferencedataListComponent implements OnInit, OnDestroy {
  ...
  parseFreeRuleEvent(eventRule) {
    eventRule['dayOfEventFreeRuleModifierTime'] =
      eventRule['dayOfEventFreeRuleModifierTime'] ? moment(eventRule['dayOfEventFreeRuleModifierTime']).format('HH:mm') + ' CST' : null;

    eventRule['dayAfterEventFreeRuleModifierTime'] =
      eventRule['dayAfterEventFreeRuleModifierTime'] ?
        moment(eventRule['dayAfterEventFreeRuleModifierTime']).format('HH:mm') + ' CST' : null;
    return eventRule;
  }
