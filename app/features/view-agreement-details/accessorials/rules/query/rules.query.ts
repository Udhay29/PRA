...
export class RulesQuery {
      ...
      'query': {
        'bool': {
          'must': [
            ...
            {
              'bool': {
                'should': this.searchFields(searchText)
              }
            }
          ]
        }
  ...
  static searchFields(searchText: string) {
    return [
      {
        'query_string': {
          'fields': ['chargeTypeName', 'equipmentClassificationCode.keyword',
      ...
      },
      {
        'nested': {
          ...
          'query': {
            'query_string': {
              'fields': ['customerAccessorialAccounts.customerAgreementContractName',
                'customerAccessorialAccounts.customerAgreementContractSectionName',
  ...
  static sort() {
    return [
      ...
      {
        'equipmentClassificationCode.raw': {
          'order': 'asc',
          'missing': '_first'
        }
      },
      {
        'equipmentClassificationTypeAssociationCode.raw': {
          'order': 'asc',
          'missing': '_first'
        }
      },
    ...
    return [
      ...
      },
      {
        'customerAccessorialNotificationFrequency.customerAccessorialNotificationBatches.batchTime': {
          ...
          'missing': '_first',
          'nested': {
            'path': 'customerAccessorialNotificationFrequency.customerAccessorialNotificationBatches'
          }
        }
      },
      {
