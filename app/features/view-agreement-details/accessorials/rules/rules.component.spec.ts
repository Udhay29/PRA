...
describe('RulesComponent', () => {
  ...
  let rulesService: RulesListService;

  configureTestSuite(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule, AppModule, ViewAgreementDetailsModule, HttpClientTestingModule],
      declarations: [],
      providers: [RulesListService, { provide: APP_BASE_HREF, useValue: '/' }]
    });
  });
  ...
  beforeEach(() => {
    ...
    rulesService = TestBed.get(RulesListService);
  });
  ...
  it('should sort data', () => {
    ...
    component.rulesModel.sortField = 'ruleType';
    component.rulesModel.sortOrder = 1;
    spyOn(RulesListService.prototype, 'getRules').and.returnValue(of(response));
    component.loadRulesData();
    component.getGridValues();
    component.loadConfigValuesLazy(event);
  });

  it('should call loadRulesData', () => {
    const gridResponse = {
      'took': 42,
      'timed_out': false,
      '_shards': {
    ...
    spyOn(RulesListService.prototype, 'getRules').and.returnValues(of(gridResponse));
    component.loadRulesData();
