    ...
    setColumns() {
        ...
        this.cols = [
            ...
            { field: 'chargeTypeName', header: 'Charge Type', sortField: 'chargeTypeName.keyword' },
            {
                ...
                sortField: 'customerAccessorialAccounts.customerAgreementContractName.keyword'
            },
            {
                field: 'sectionsToShow', header: 'Section', isArray: true,
                sortField: 'customerAccessorialAccounts.customerAgreementContractSectionName.keyword'
            },
            {
            ...
            { field: 'equipmentClassificationCode', header: 'Equipment Category', sortField: 'equipmentClassificationCode.raw' },
            { field: 'equipmentClassificationTypeAssociationCode', header: 'Equipment Type',
             sortField: 'equipmentClassificationTypeAssociationCode.raw' },
            ...
            },
            {
                ...
                sortField: 'customerAccessorialAccounts.customerAgreementContractSectionAccountName.keyword'
            },
            {
            ...
            },
            {
                ...
                sortField: 'customerAccessorialNotificationFrequency.timeframeQuantity.integer'
            },
            {
